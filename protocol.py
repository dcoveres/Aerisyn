...
# Анти-спам ограничение (аналог Telegram): если пользователь A первым
# написал незнакомому пользователю B, а B заблокировал A, ни разу ему
# не ответив, то A на этот срок теряет возможность первым писать
# незнакомым людям (уже существующие чаты не затрагиваются).
SPAM_BLOCK_DURATION_DAYS = 14
SPAM_BLOCK_DURATION = SPAM_BLOCK_DURATION_DAYS * 86400

# Системный бот, сообщающий статус анти-спам ограничений (аналог @spambot в Telegram)
SPAMBOT_USERNAME = "spambot"
SPAMBOT_SYSTEM_EMAIL = "spambot@system.local"
SPAMBOT_DISPLAY_NAME = "SpamBot"
...
CMD_GET_ANALYTICS = "get_analytics"
CMD_CREATE_POLL = "create_poll"
CMD_VOTE_POLL = "vote_poll"
CMD_CLOSE_POLL = "close_poll"
CMD_SEARCH = "search"
CMD_BLOCK_USER = "block_user"
CMD_UNBLOCK_USER = "unblock_user"
CMD_GET_BLACKLIST = "get_blacklist"
...
CMD_GET_SESSIONS = "get_sessions"
CMD_TERMINATE_SESSION = "terminate_session"
